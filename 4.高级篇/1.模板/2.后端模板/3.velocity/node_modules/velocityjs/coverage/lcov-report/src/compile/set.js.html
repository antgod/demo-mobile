...
<html lang="en">
<head>
    <title>Code coverage report for src/compile/set.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/compile/set.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/compile/</a> &#187; set.js</div>
</div>
<div class="body">
...
&nbsp;
        ...
        var len = ref.path ? ref.path.length: <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
&nbsp;
        //console.log(val);
...
&nbsp;
          ...
          baseRef[key] = isEnd? val: <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
          baseRef = baseRef[key];
&nbsp;
        });
&nbsp;

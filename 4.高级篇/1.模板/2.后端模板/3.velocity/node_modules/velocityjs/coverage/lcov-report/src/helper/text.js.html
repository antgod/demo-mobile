...
<html lang="en">
<head>
    <title>Code coverage report for src/helper/text.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/helper/text.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/helper/</a> &#187; text.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = function(Helper, utils){
  /**
...
&nbsp;
        ret += '[' + text + ']';
&nbsp;
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (ref.type == 'property') {
&nbsp;
        ret += '.' + ref.id;
&nbsp;
      }

...
<html lang="en">
<head>
    <title>Code coverage report for src/compile/references.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/compile/references.js</span></h1>
    <h2>
        
        Statements: <span class="metric">98.58% <small>(139 / 141)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">95.92% <small>(94 / 98)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(17 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">98.53% <small>(134 / 136)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/compile/</a> &#187; references.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = function(Velocity, utils) {
&nbsp;
  'use strict';
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!utils.isArray(key)) key = [key]
&nbsp;
...
&nbsp;
      if (text in context) {
        return (ast.prue &amp;&amp; escape) ? convert(context[text]) : <span class="branch-1 cbranch-no" title="branch not covered" >context[text];</span>
      }
&nbsp;
&nbsp;
...
&nbsp;
    ...
    getPropIndex: function(property, baseRef) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (ast.type === 'integer') {
        key = ast.value;
      } else {
<span class="cstat-no" title="statement not covered" >        key = ast.value;</span>
      }
&nbsp;
      return baseRef[key];
    },
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (ret &amp;&amp; ret.call) {
&nbsp;
          var that = this;
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jul 06 2015 23:17:32 GMT+0800 (CST)</div>
</div>

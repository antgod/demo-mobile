...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/parse.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; parse.js</div>
</div>
<div class="body">
...
&nbsp;
  return utils.isArray(ret) ? ret : <span class="branch-1 cbranch-no" title="branch not covered" >ret.arr;</span>
};
&nbsp;
